...
class FilterDateDropdown extends BEMBlock {
  ...
  handleCalAttrsChanges() {
    if (this.calendar.hasAttribute('data-date-is-ready')) {
      ...
      this.elemsMap.sign.innerText = `${
        this.formateDate(new Date(data.startDate))
  ...
  setHandleWindowClick() {
    this.handleWindowClick = () => {
      if (this.closeTrigger) {
        ...
        this.elemsMap.calendarWrapper
          .classList.add(this.mods.calendarWrapperHidden);
      }
      this.closeTrigger = true;
    };
  }
  ...
  setHandleBtnClick() {
    this.handleBtnClick = () => {
      ...
      this.elemsMap.calendarWrapper
        .classList.toggle(this.mods.calendarWrapperHidden);
    };
  }
