...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _decrease_button_dropdown_decrease_button_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./__decrease-button/dropdown__decrease-button.js */ \"./src/library.blocks/dropdown/__decrease-button/dropdown__decrease-button.js\");\n/* harmony import */ var _increase_button_dropdown_increase_button_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./__increase-button/dropdown__increase-button.js */ \"./src/library.blocks/dropdown/__increase-button/dropdown__increase-button.js\");\n\n\n\nlet dropdowns = Array.from(document.querySelectorAll('.dropdown'));\ndropdowns.forEach(dropdown => dropdown.addEventListener('click', f));\n\nfunction f() {\n    let prop = methodsProp.find( prop => methods.targetElem = event.target.closest(`.${prop}`) );\n    if (methods.targetElem) methods[prop]();\n}\n\nlet methods = {\n    dropdown__button: function() {\n        console.log(this.targetElem)\n    },\n\n    'dropdown__increase-button': function() {\n        _increase_button_dropdown_increase_button_js__WEBPACK_IMPORTED_MODULE_1__[\"increaseButton\"].call(this)\n    }, \n\n    'dropdown__decrease-button': function() {\n        _decrease_button_dropdown_decrease_button_js__WEBPACK_IMPORTED_MODULE_0__[\"decreaseButton\"].call(this)\n    }, \n}\n\nlet methodsProp = Object.keys(methods);\n\n\n//# sourceURL=webpack:///./src/library.blocks/dropdown/dropdown.js?");
